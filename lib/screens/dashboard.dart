...
import 'package:tictapp_driver/sidemenu/drawer.dart';
import 'package:tictapp_driver/utils/common.dart';
import 'package:http/http.dart' as http;
import 'package:tictapp_driver/widgets/order_list_cell.dart';
  ...
  List<Widget> createOrderCell() {
    ...
    for (int i = 0; i < orderList.length; i++) {
      if (orderList[i]['order_status'] == "Pending" ||
          orderList[i]['order_status'] == "Shopping Started" ||
          orderList[i]['order_status'] == "Shopping Completed" ||
          orderList[i]['order_status'] == "Out for Delivery")
