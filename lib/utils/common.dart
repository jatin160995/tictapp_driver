...
const driverOrders = url_string + "index.php?route=api/driver/order";
const login = url_string + "index.php?route=api/driver/login";
const finishOrderUrl = url_string + "index.php?route=api/driver/order/addHistory";
const orderDetailUrl = url_string + "index.php?route=api/driver/order/get";
const orderEditUrl = url_string + "index.php?route=api/driver/order/update";
